									...
									<ul class="item rows admSortTable">
										<c:forEach items="${keyboard}" var="keyboard">
											<c:forEach items="${keyboard.files}" var="file">
												<li>
													<div class="item-image"><a href='<c:url value="/peripheral/peripheral.do/${keyboard.peripheralNo}"/>'><img class="image" src="<c:url value='${file.filePath}'/>"></a></div>
													<div class="item-content">
														<div class="subject"><a href='<c:url value="/peripheral/peripheral.do/${keyboard.peripheralNo}"/>'>${keyboard.peripheralTitle}</a></div>
													</div>
													<div class="info">
														<div class="pull-left">
															<span><fmt:formatNumber value="${keyboard.peripheralSalePrice}" type="number" pattern="#,###"/></span>
														</div>
													</div>
												</li>
											</c:forEach>
