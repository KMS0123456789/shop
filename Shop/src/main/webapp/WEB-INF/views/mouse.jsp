				...
				<div class="contents">
					...
					<div class="category-product">
						<div class="list-info-box">
							<ul class="list-sort">
								<li class="on"><a href="<c:url value='/peripheral/mouse.do'/>">최신순</a></li>
								<li><a href="<c:url value='/peripheral/mouseHighPrice.do'/>">높은 가격</a></li>
								<li><a href="<c:url value='/peripheral/mouseLowPrice.do'/>">낮은 가격</a></li>
							</ul>
						</div>
									...
									<ul class="item rows admSortTable">
										<c:forEach items="${mouse}" var="mouse">
											<c:forEach items="${mouse.files}" var="file">
												<li>
													<div class="item-image"><a href='<c:url value="/peripheral/peripheral.do/${mouse.peripheralNo}"/>'><img class="image" src="<c:url value='${file.filePath}'/>"></a></div>
													<div class="item-content">
														<div class="subject"><a href='<c:url value="/peripheral/peripheral.do/${mouse.peripheralNo}"/>'>${mouse.peripheralTitle}</a></div>
													</div>
													<div class="info">
														<div class="pull-left">
															<span><fmt:formatNumber value="${mouse.peripheralSalePrice}" type="number" pattern="#,###"/></span>
														</div>
													</div>
												</li>
											</c:forEach>
