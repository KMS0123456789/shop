...
<head>
    ...
    <title>주문</title>
    <link href="<c:url value='/resources/css/orderComputerPeripheral.css' />" rel="stylesheet">
    <!-- 포트원 결제 -->
...
<body>
    ...
    <div class="order-page">
        ...
        <table class="order-items">
            ...
            <tbody>
                <tr>
                    <td>
                        <img src="<c:url value='${detail.filePath}' />" alt="Product" class="product-image">
        ...
        <div class="order-info-summary">
            ...
            <div class="payment-summary">
                <h3>결제정보</h3>
                <p class="total">${detail.computerSalePrice + detail.ssdPrice + detail.hddPrice + detail.osPrice + 3000}원</p>
                <span>총 상품가격</span>
                <span id="total-product-price">${detail.computerSalePrice + detail.ssdPrice + detail.hddPrice + detail.osPrice}원</span> + 
                <span>배송비</span>
                <span id="shipping-fee">3000원</span>
	...
	function completeComputerBuy(paymentResult) {
	    $.ajax({
	        url: '<c:url value="/ask/completeComputerBuy.do"/>',
	        method: 'POST',
	        data: {
	        	"askNo" : ${detail.askNo}
	        },
	        success: function() {
	        	window.location.href = '<c:url value="/ask/orderCompleteComputer.do?askNo="/>'+${detail.askNo};
	        },
	        error: function(xhr, status, error) {
