...
<body>
    ...
    <div class="order-page">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="price" style="text-align: center">
					    <strong>
					        <fmt:formatNumber value="${detail.peripheralSalePrice}" type="number" pattern="#,###"/>원
					    </strong>
					</td>
                </tr>
            </tbody>
        ...
        <div class="order-info-summary">
            ...
            <div class="payment-summary">
                <h3>결제정보</h3>
                <p class="total">${detail.peripheralSalePrice+ 3000}원</p>
                <span>총 상품가격</span>
                <span id="total-product-price">${detail.peripheralSalePrice}원</span> + 
                <span>배송비</span>
	...
	function completeComputerBuy(paymentResult) {
	    $.ajax({
	        url: '<c:url value="/ask/completePeripheralBuy.do"/>',
	        method: 'POST',
	        data: {
	        	"askNo" : ${detail.askNo}
	        },
	        success: function() {
	        	window.location.href = '<c:url value="/ask/orderCompletePeripheral.do?askNo="/>'+${detail.askNo};
	        },
	        error: function(xhr, status, error) {
